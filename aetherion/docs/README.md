...
الإصدار **1.2.0** — متوافق مع MT5 Build 4000+ (كشف الملء FOK / IOC / RETURN، مستوى الوقف، التجميد، تطبيع اللوت حسب خطوة الرمز).

جديد في 1.2: إغلاق الصفقات قبل عطلة الأسبوع، تجاهل السوق الهادئ/الهائج، دخول الاتجاه عند ارتداد EMA، تعادل بعد الإغلاق الجزئي، فلتر فجوة للذهب والنفط، سقف مدة 24 ساعة، ونافذة أخبار افتراضية.  
جديد في 1.1: فلتر إطار أعلى، تأكيد الشموع، رول أوفر، سلسلة خسائر، استقرار السبريد. `DetectAsset` لا يحذف كل حرف `M`.
...
- اختصارات: Space تشغيل/إيقاف · ←→ شمعة · مسح مكتبة التقارير · إعداد تلقائي حسب الأصل  
