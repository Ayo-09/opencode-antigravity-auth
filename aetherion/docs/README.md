...
الإصدار **1.1.0** — متوافق مع MT5 Build 4000+ (كشف الملء FOK / IOC / RETURN، مستوى الوقف، التجميد، تطبيع اللوت، والهامش).

جديد في 1.1: فلتر إطار أعلى، تأكيد الشموع، إيقاف الرول أوفر 23:50–00:20، إيقاف بعد سلسلة خسائر، واستقرار السبريد قبل الدخول. `DetectAsset` لم يعد يحذف كل حرف `M` (AMZN / MSFT / MATIC تبقى صحيحة).
